...
The `github` command creates GitHub issues from comments in a YAML file,
enabling collaborative review and tracking of ISO comment resolution.
...
[source,shell]
----
$ commenter github comments.yaml --config github_config.yaml --stage DIS
----
...
[source,shell]
----
$ commenter github comments.yaml --config github_config.yaml --dry-run
----
====
...
** `github` - Create GitHub issues from comments
